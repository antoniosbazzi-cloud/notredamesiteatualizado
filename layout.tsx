...
export const metadata: Metadata = {
  title: "Notre Dame Intermédica - ALB Consultoria",
  description: "Planos de Saúde Notre Dame Intermédica com as Melhores Condições",
  generator: "v0.dev",
}
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `
              ...
              'https://www.googletagmanager.com/gtm.js?id=GTM-T9S32SMW'+dl;
            ...
            __html: `
              ...
              window.gtag_report_conversion = function(url) {
                ...
                gtag('event', 'conversion', {
                    'send_to': 'AW-17424404960/_7peCODqtYYbEOCjzfRA',
